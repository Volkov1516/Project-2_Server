...
export const readProjectModel = async (id: string): Promise<Project | undefined> => {
  return projects.find(p => p.id === id);
};

export const updateProjectModel = async (id: string, data: Partial<Project>): Promise<Project | undefined> => {
